...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/cart-checkout/src/index.jsx
  ...
  function useTranslate() {
    ...
    var translate = (0, import_react7.useCallback)(function() {
      var translation = i18n.translate.apply(i18n, arguments);
      if (!Array.isArray(translation)) {
        return translation;
      }
      return translation.map(function(part, index) {
        if (/* @__PURE__ */ (0, import_react7.isValidElement)(part)) {
          return /* @__PURE__ */ (0, import_react7.cloneElement)(part, {
            key: index
          });
        }
        return part;
  ...
  function App() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Banner2, {
      title: "cart-checkout",
      children: translate("welcome", { extensionPoint })
    });
  }
})();
